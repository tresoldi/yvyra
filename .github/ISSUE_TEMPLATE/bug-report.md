...
<!-- Please include exact output from the yvyra run that shows what's
...
### Would you be able to compile and run yvyra to test fixes to this bug?
  - [ ] Yes, I know how to use `git` and how to compile yvyra.
  - [ ] No, sorry.

### What is the environment that you run yvyra in?
  - Operating system (including variant and release):
  - Version of yvyra:
  - If possible, include the output of the `Version` command in yvyra below:
